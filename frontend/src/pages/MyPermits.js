      ...
      <main className="main-content">
        <div className="page-header">
          <div className="breadcrumb">
            Dashboard / <span>My Applications</span>
          </div>
                      ...
                      <td style={{ fontSize: 12 }}>
                        {p.assessedFee ? (
                          <span style={{ color: "#854d0e", fontWeight: 600 }}>
                            ₱{Number(p.assessedFee).toLocaleString()}
                          </span>
                        ) : (
        ...
        <div className="card" style={{ padding: 16 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
            {[
              [
                "pending",
                "Waiting for initial review by the Engineering Office",
              ],
              [
                "under_review",
                "Being evaluated; plans and documents under assessment",
              ],
              [
                "scheduled_for_inspection",
                "Inspection of property scheduled — check your permit details",
              ],
              [
                "for_payment",
                "Fees assessed; please proceed to payment at the Municipal Treasury",
              ],
              ["approved", "Permit approved — ready to be released"],
              ["released", "Permit issued and released to applicant"],
              [
                "rejected",
                "Application rejected — see reason in permit details",
              ],
