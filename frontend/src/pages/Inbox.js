  ...
  const openMessage = async (msg) => {
    ...
    try {
      ...
      if (tab === "inbox") {
        ...
        setMessages((prev) =>
          prev.map((m) =>
            m.threadId === msg.threadId ? { ...m, isRead: true } : m,
          ),
        );
      }
      // Load full thread
  ...
  const renderThread = () => {
    ...
    thread.forEach((msg, i) => {
      ...
      items.push(
        <div
          key={msg._id}
          className={`thread-bubble ${isSent ? "sent" : "received"}`}
        >
          <div className="thread-bubble-meta">
            {!isSent && (
              <div
                ...
                style={{
                  ...
                  fontSize: 10,
                  background:
                    msg.sender?.role === "admin" ? "#1e4e78" : "#e8a020",
                  color: msg.sender?.role === "admin" ? "#fff" : "#1e4e78",
                }}
              >
            ...
            <span className="thread-sender">
              {isSent ? "You" : msg.sender?.fullName}
            </span>
    ...
    <div className="layout">
      ...
      <main className="main-content">
        ...
        >
          {/* LEFT: Message List */}
          <div
            className="card inbox-list-panel"
            style={{
              padding: 0,
              overflow: "hidden",
              display: "flex",
              ...
              {loadingList ? (
                ...
                <div className="message-list">
                  {messages.map((msg) => {
                    ...
                    const contact =
                      tab === "inbox" ? msg.sender : msg.recipient;
                    return (
                      <div
                        key={msg._id}
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            background:
                              contact?.role === "admin" ? "#1e4e78" : "#e8a020",
                            color:
                              contact?.role === "admin" ? "#fff" : "#1e4e78",
                            width: 34,
                            height: 34,
                            fontSize: 11,
                          }}
          ...
          {/* RIGHT: Thread View */}
          <div
            className="card inbox-view-panel"
            style={{
              padding: 0,
              display: "flex",
              flexDirection: "column",
                ...
                >
                  ...
                  >
                    ...
                    {selected.permit && (
                      ...
                      >
                        📋 {selected.permit.transactionNumber}
                      </span>
                    )}
                  </div>
                </div>
            ...
            <div className="compose-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={sendCompose}>
                <div className="form-group">
                  ...
                  <input
                    className="form-control"
                    value="Engineering Office — Municipality of Balagtas"
                    disabled
